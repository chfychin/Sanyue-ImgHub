<template>
    <div class="upload-home">
        ...
        <div class="header">
            <a href="https://github.com/chfychin/cf-imgbed">
                <img class="logo" alt="Chfy logo" :src="logoUrl"/>
            </a> 
            <h1 class="title"><a class="main-title" href="https://github.com/chfychin/cf-imgbed" target="_blank">{{ ownerName }}</a> ImgHub</h1>
        </div>
        <UploadForm 
...
export default {
    ...
    computed: {
        ...
        ownerName() {
            return this.userConfig?.ownerName || 'Chfy'
        },
        logoUrl() {
